...
require './lib/cdris/gateway/provider'
require 'fakeweb'

describe Cdris::Gateway::Provider do
  ...
  describe 'self.create' do
    ...
    context 'when the server returns a 400 error' do
      ...
      it 'raises a provider invalid error' do
        expect { described_class.create(body) }.to raise_error(Cdris::Gateway::Exceptions::ProviderInvalidError)
      end
    end
  ...
  describe 'self.get' do
    ...
    context 'when the server returns a 400 error' do
      ...
      it 'raises a provider invalid error' do
        expect { described_class.get(id: 'd') }.to raise_error(Cdris::Gateway::Exceptions::ProviderInvalidError)
      end
    end
    ...
    context 'when the server returns a 404 error' do
      ...
      it 'raises a provider not found error' do
        expect { described_class.get(id: 1) }.to raise_error(Cdris::Gateway::Exceptions::ProviderNotFoundError)
      end
    end
  end
  ...
  describe 'self.update_by_id' do
    ...
    context 'when the server returns a 400 error' do
      ...
      it 'raises a provider invalid error' do
        expect { described_class.update_by_id(id: 1) }.to raise_error(Cdris::Gateway::Exceptions::ProviderInvalidError)
      end
    end
    ...
    context 'when the server returns a 404 error' do
      ...
      it 'raises a provider not found error' do
        expect { described_class.update_by_id(id: 1) }.to raise_error(Cdris::Gateway::Exceptions::ProviderNotFoundError)
      end
    end
  end
  ...
  describe 'self.delete_by_id' do
    ...
    context 'when the server returns a 404 error' do
      ...
      it 'raises a Provider not found error' do
        expect { described_class.delete_by_id(id: 1) }.to raise_error(Cdris::Gateway::Exceptions::ProviderNotFoundError)
      end
    end
  end
end
