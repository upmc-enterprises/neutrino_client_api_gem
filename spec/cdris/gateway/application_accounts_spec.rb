...
describe Cdris::Gateway::ApplicationAccounts do
  ...
  describe 'self.create' do
    ...
    context 'when the server returns a 400 error' do
      ...
      it 'raises an error' do
        expect { described_class.create(new_account) }.to raise_error(Cdris::Gateway::Exceptions::UnableToCreateApplicationAccountsError)
      end
    end
  ...
  describe 'self.index' do
    ...
    context 'when the server returns a 400 error' do
      ...
      it 'raises an error' do
        expect { described_class.index }.to raise_error(Cdris::Gateway::Exceptions::UnableToRetrieveApplicationAccountsError)
      end
    end
  ...
  describe 'self.find_by_id' do
    ...
    context 'when the server returns a 400 error' do
      ...
      it 'raises an error' do
        expect { described_class.find_by_id(1) }.to raise_error(Cdris::Gateway::Exceptions::UnableToRetrieveApplicationAccountsError)
      end
    end
  ...
  describe 'self.update_by_id' do
    ...
    context 'when the server returns a 400 error' do
      ...
      it 'raises an error' do
        expect { described_class.update_by_id(1, update_account) }.to raise_error(Cdris::Gateway::Exceptions::UnableToUpdateApplicationAccountsError)
      end
    end
