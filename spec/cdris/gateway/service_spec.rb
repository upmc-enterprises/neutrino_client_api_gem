...
require './lib/cdris/gateway/service'
require './lib/cdris/gateway/requestor'
require 'fakeweb'


describe Cdris::Gateway::Service do
  ...
  describe 'self.data' do
    ...
    context 'when no params are given' do
      ...
      it 'raises a BadRequestError' do
        expect { described_class.data(params) }.to raise_error(Cdris::Gateway::Exceptions::BadRequestError)
      end
    end
    ...
    context 'when a document is not found' do
      ...
      it 'raises a DerivedWorkDocumentNotFoundError' do
        ...
        end.to raise_error(Cdris::Gateway::Exceptions::DerivedWorkDocumentNotFoundError)
      end
    end
  end
  ...
  describe 'self.metadata' do
    ...
    context 'when no params are given' do
      ...
      it 'raises a BadRequestError' do
        expect { described_class.metadata(params) }.to raise_error(Cdris::Gateway::Exceptions::BadRequestError)
      end
    end
  ...
  describe 'self.base_uri' do
    ...
    context 'when service_class and service_identifier are not in params a bad request error is thrown' do
      ...
      it 'returns a URI service_class and service_identifier' do
        expect { described_class.base_uri(params, options) }.to raise_error(Cdris::Gateway::Exceptions::BadRequestError)
      end
    end
