...
describe Documents::Gateway::Info do
  ...
  describe 'self.deployments' do
    ...
    it 'returns the expected deployments' do
      WebMock.stub_request(
        :get,
        'http://testhost:4242/documents_service/deployments?user%5Bextension%5D=spameggs&user%5Broot%5D=foobar')
  ...
  describe 'self.current_deployment' do
    ...
    it 'returns the expected current_deployment' do
      WebMock.stub_request(
        :get,
        'http://testhost:4242/documents_service/deployment/current?user%5Bextension%5D=spameggs&user%5Broot%5D=foobar')
        .with(headers: { 'X-Forwarded-For' => REMOTE_IP })
  ...
  describe 'self.configuration' do
    ...
    context 'with an implicit tenant' do
      it 'returns the expected configuration when a category is given' do
        WebMock.stub_request(
          :get,
          'http://testhost:4242/documents_service/configuration/a_category?user%5Bextension%5D=spameggs&user%5Broot%5D=foobar')
          .with(headers: { 'X-Forwarded-For' => REMOTE_IP })
      ...
      it 'returns all configurations when a category is not given' do
        WebMock.stub_request(
          :get,
          'http://testhost:4242/documents_service/configuration?user%5Bextension%5D=spameggs&user%5Broot%5D=foobar')
    ...
    context 'with an explicit tenant' do
      ...
      it 'returns the expected configuration when a category is given' do
        WebMock.stub_request(
            :get,
            'http://testhost:4242/documents_service/configuration/a_category?user%5Bextension%5D=spameggs&user%5Broot%5D=foobar&tid=some_tenant')
            .with(headers: { 'X-Forwarded-For' => REMOTE_IP })
            .to_return(body: DataSamples.info_configuration.to_s)
      ...
      it 'returns all configurations when a category is not given' do
        WebMock.stub_request(
          :get,
          'http://testhost:4242/documents_service/configuration?user%5Bextension%5D=spameggs&user%5Broot%5D=foobar&tid=some_tenant')
          .with(headers: { 'X-Forwarded-For' => REMOTE_IP })
          .to_return(body: DataSamples.info_configurations.to_s)
