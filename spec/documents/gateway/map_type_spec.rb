...
describe Neutrino::Gateway::MapType do
  ...
  describe 'self.get' do
    ...
    it 'gets a map_type' do
      ...
      expect(described_class.get(param_unmapped, OPTIONS_WITH_REMOTE_IP)).to eq(DataSamples.map_type_get.to_hash)
    end
  ...
  describe 'self.get_summary_by_type' do
    ...
    it 'gets a map_type' do
      ...
      expect(described_class.get_summary_by_type(OPTIONS_WITH_REMOTE_IP)).to eq(expected_summary)
    end
  ...
  describe 'self.get_total_document_count_to_update' do
    ...
    it 'gets a count of remaining documents' do
      ...
      expect(described_class.get_total_document_count_to_update(OPTIONS_WITH_REMOTE_IP)).to eq(sample_document_to_update_count)
    end
