  ...
  describe 'self.find_by_id' do
    ...
    context 'when the server returns a 400 error' do
      ...
      it 'raises an error' do
        expect { described_class.find_by_id(1) }.to raise_error(Neutrino::Gateway::Exceptions::UnableToRetrieveTenantsError)
      end
    end
  end
  ...
  describe 'self.update_by_id' do
    ...
    context 'when the server returns a 400 error' do
      ...
      it 'raises a tenant invalid error' do
        expect { described_class.update_by_id(1, response_message) }.to raise_error(Neutrino::Gateway::Exceptions::UnableToUpdateTenantError)
      end
    end
    ...
    context 'when the server returns a 404 error' do
      ...
      it 'raises a tenant invalid error' do
        expect { described_class.update_by_id(1, response_message) }.to raise_error(Neutrino::Gateway::Exceptions::UnableToRetrieveTenantsError)
      end
    end
  end
