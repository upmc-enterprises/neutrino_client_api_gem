module Neutrino
  module Gateway
    ...
    module Exceptions
      ...
      # Error class for when NEUTRINO is unable to parse version information
      class UnableToParseVersionInformationError < BaseError
        def initialize(errors = [], message = 'NEUTRINO was unable to parse version information')
          super(errors, message)
        end
      end
      ...
      class UnableToParseVersionHistoryError < BaseError
        def initialize(errors = [], message = 'NEUTRINO was unable to parse version history')
          super(errors, message)
        end
      end
      ...
      class UnableToCreateApplicationAccountsError < BaseError
        def initialize(errors = [], message = 'NEUTRINO was unable to create application account')
          super(errors, message)
        end
      end
      ...
      class UnableToRetrieveApplicationAccountsError < BaseError
        def initialize(errors = [], message = 'NEUTRINO was unable to retrieve application accounts')
          super(errors, message)
        end
      end
      ...
      class UnableToUpdateApplicationAccountsError < BaseError
        def initialize(errors = [], message = 'NEUTRINO was unable to update application account')
          super(errors, message)
        end
      end

      class UnableToUpdateTenantError < BaseError
        def initialize(errors = [], message = 'NEUTRINO was unable to update tenant')
          super(errors, message)
        end
      end

      # Error class for when NEUTRINO is unable to retrieve the list of tenants
      class UnableToRetrieveTenantsError < BaseError
        def initialize(errors = [], message = 'NEUTRINO was unable to retrieve tenants')
          super(errors, message)
        end
      end

      # Error class for when NEUTRINO is unable to retrieve configurations
      class UnableToRetrieveConfigurations < BaseError
        def initialize(errors = [], message = 'NEUTRINO was unable to retrieve configuration')
          super(errors, message)
        end
      end
