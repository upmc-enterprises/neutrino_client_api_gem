...
module Cdris
  module Gateway
    class Service < Cdris::Gateway::Requestor
      ...
      class << self
        ...
        def data(params, options = {})
          ...
          request(path, options).if_404_raise(Cdris::Gateway::Exceptions::DerivedWorkDocumentNotFoundError)
              .data_and_type
        end
        ...
        def base_uri(params, options)
          ...
          if params[:service_class] && params[:service_identifier]
            ...
            fail Cdris::Gateway::Exceptions::BadRequestError, 'Must provide an service_class and service_identifier'
          end
          path
        end
