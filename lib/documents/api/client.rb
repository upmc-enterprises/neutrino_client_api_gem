  ...
  module Api
    class Client
      ...
      class << self
        ...
        # Gets and sets the base URI for Documents
        #
        ...
        # Performs a request on the Documents API
        #
        ...
        # @raise [Exceptions::InternalServerError] when the Documents API responds with 500 code
        ...
        # Builds a REST request to be sent to the Documents API.
        ...
        # @param [String] path Path of Documents API from which to request information.
        ...
        # @return [Http::Response] response from the Documents API service
        ...
        # Provides the RESTFUL path and parameters for a call to the Documents CORE API
        # @return [String] The API path and parameters to be passed to the Documents CORE API
