module Documents
  module Gateway
    ...
    module Exceptions
      ...
      # Error class for when DOCUMENTS is unable to parse version information
      class UnableToParseVersionInformationError < BaseError
        def initialize(errors = [], message = 'Documents was unable to parse version information')
          super(errors, message)
        end
      end
      ...
      class UnableToParseVersionHistoryError < BaseError
        def initialize(errors = [], message = 'Documents was unable to parse version history')
          super(errors, message)
        end
      end

      # Error class for when Documents is unable to create a list of application accounts
      class UnableToCreateApplicationAccountsError < BaseError
        def initialize(errors = [], message = 'Documents was unable to create application account')
          super(errors, message)
        end
      end

      # Error class for when Documents is unable to retrieve an application account
      class UnableToRetrieveApplicationAccountsError < BaseError
        def initialize(errors = [], message = 'Documents was unable to retrieve application accounts')
          super(errors, message)
        end
      end

      # Error class for when Documents is unable to unable a list of application accounts
      class UnableToUpdateApplicationAccountsError < BaseError
        def initialize(errors = [], message = 'Documents was unable to update application account')
          super(errors, message)
        end
      end

      class UnableToUpdateTenantError < BaseError
        def initialize(errors = [], message = 'Documents was unable to update tenant')
          super(errors, message)
        end
      end

      # Error class for when DOCUMENTS is unable to retrieve the list of tenants
      class UnableToRetrieveTenantsError < BaseError
        def initialize(errors = [], message = 'Documents was unable to retrieve tenants')
          super(errors, message)
        end
      end

      # Error class for when DOCUMENTS is unable to retrieve configurations
      class UnableToRetrieveConfigurations < BaseError
        def initialize(errors = [], message = 'Documents was unable to retrieve configuration')
          super(errors, message)
        end
      end
