  ...
  module Gateway
    class MapType < Documents::Gateway::Requestor
      ...
      class << self
        ...
        # @raise [Exceptions::MapTypeNotFoundError] when DOCUMENTS returns a 404 status code
        ...
        # @param [Hash] options specify query values
        # @return [Hash] the DOCUMENTS response body
        ...
        # Constructs the body expected by DOCUMENTS for multipart mapping document
        #   imports.
        #
        # @param [ActionDispatch::Http::UploadedFile] uploaded_file The file to
        #   be uploaded to DOCUMENTS (as, for example, submitted in a web form)
