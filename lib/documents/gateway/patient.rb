  ...
  module Gateway
    class Patient < Documents::Gateway::Requestor
      ...
      class << self
        ...
        # @raise [Exceptions::PatientNotFoundError] when DOCUMENTS returns a 404 status
        ...
        # @raise [Exceptions::InvalidTenantOperation] when DOCUMENTS returns a 403 status
        ...
        # @raise [Exceptions::BadRequestError] when DOCUMENTS returns a 400 status
