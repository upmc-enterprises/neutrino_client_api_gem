  ...
  module Gateway
    class PatientDocument < Documents::Gateway::Requestor
      ...
      class << self
        ...
        # @raise [Exceptions::PatientDocumentNotFoundError] when DOCUMENTS returns a 404 status code
        ...
        # @raise [Documents::Gateway::Exceptions::BadRequestError] when DOCUMENTS returns a 400 status
        # @raise [Documents::Gateway::Exceptions::InvalidTenantOperation] when DOCUMENTS returns a 403 status
        # @raise [Documents::Gateway::Exceptions::PatientDocumentNotFoundError] when DOCUMENTS returns a 404 status
        ...
        # @param [Hash] options specify query values
        # @return [Hash] the patient document
        # @raise [Exceptions::BadRequestError] when DOCUMENTS returns a 400 status code
        def search(options = {})
        ...
        # @return [Hash] DOCUMENTS response
        ...
        # @raise [Exceptions::BadRequestError] when DOCUMENTS returns a 4xx status
